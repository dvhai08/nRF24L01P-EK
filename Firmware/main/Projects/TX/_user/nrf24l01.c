...
/* Flush FIFOs */
#define NRF24L01_FLUSH_TX							do { NRF24L01_CSN_LOW; SPI_RW(NRF24L01_FLUSH_TX_MASK); NRF24L01_CSN_HIGH; } while (0)
#define NRF24L01_FLUSH_RX							do { NRF24L01_CSN_LOW; SPI_RW(NRF24L01_FLUSH_RX_MASK); NRF24L01_CSN_HIGH; } while (0)
...
uint8_t TM_NRF24L01_ReadRegister(uint8_t reg) {
	uint8_t value;
	NRF24L01_CSN_LOW;
	SPI_RW(NRF24L01_READ_REGISTER_MASK(reg));
	value = SPI_RW(NRF24L01_NOP_MASK);
	NRF24L01_CSN_HIGH;
